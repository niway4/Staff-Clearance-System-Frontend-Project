    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-backgroundColor">
      ...
      <header className="w-full flex items-center justify-between px-6 md:px-12 py-4 bg-sideBarColor shadow-lg sticky top-0 z-50">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link to="/" className="text-white hover:text-lightGold transition-colors duration-300">
            Home
          </Link>
          <Link to="/about" className="text-white hover:text-lightGold transition-colors duration-300">
            About
          </Link>
          <Link to="/contact" className="text-white hover:text-lightGold transition-colors duration-300">
            Contact
          </Link>
          <Link to="/Login">
        ...
        <div className="max-w-7xl w-full mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
            ...
            >
              ...
              >
                Simplify your clearance process with our digital platform. Track progress, receive updates, and complete
                all departmental clearances efficiently in one centralized system.
              </motion.p>
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-sideBarColor mb-8 text-center">
              Designed for <span className="text-gold">Everyone</span> in Your Organization
            </h2>
            ...
            <div className="grid gap-8 md:grid-cols-3 w-full">
              {[
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-sideBarColor mb-3">{item.title}</h3>
          ...
          >
            ...
            <p className="text-blue-100 text-center max-w-2xl mx-auto mb-8">
              Watch our quick tutorial to see how easy it is to manage the clearance process with our system.
            </p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Real-time Updates", desc: "Get instant notifications on clearance progress" },
                { title: "Digital Signatures", desc: "Approve documents with secure digital signatures" },
                { title: "Document Storage", desc: "Access all your clearance documents in one place" },
                { title: "Automated Workflows", desc: "Predefined processes ensure nothing is missed" },
              ].map((feature, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <h3 className="text-lg font-semibold text-sideBarColor mb-2">{feature.title}</h3>
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Join hundreds of organizations that have simplified their employee clearance procedures.
            </p>
            <Link to="/Login">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/Logo.png" alt="Logo" className="h-10 w-10 rounded-full object-cover border border-gold" />
              <span className="font-bold text-xl">ClearanceSystem</span>
            </div>
            <p className="text-blue-200 mb-4 max-w-md">
              Simplifying the employee clearance process with our comprehensive digital platform.
            </p>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4 text-lightGold">Quick Links</h3>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4 text-lightGold">Contact Us</h3>
            <ul className="space-y-2">
