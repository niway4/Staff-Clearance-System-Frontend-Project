...
//         <div className="flex flex-col items-center justify-center border-sideBarColor border h-fit w-4/6 p-4 m-6 bg-lightGray rounded-lg shadow-xl">
//           <form onSubmit={handleSubmit} className="w-full space-y-4 ">
//             <label htmlFor="employeename" className="block">First Name:</label>
//             <input
//               type="text"
//               id="fname"
//               name="fname"
...
//               required
//             />
//             <label htmlFor="lname" className="block">Middle Name:</label>
//             <input
//               type="text"
//               id="lname"
//               name="lname"
...
//               required
//             />
//             <label htmlFor="sname" className="block">Last Name:</label>
//             <input
//               type="text"
//               id="sname"
//               name="sname"
...
//                 name="is_academic"
//                 checked={formData.is_academic}
//                 onChange={(e) => setFormData({ ...formData, is_academic: e.target.checked })}
//                 className="w-6 h-6 text-sideBarColor border-gray-300 rounded focus:ring-sideBarColor"
//               />
//               <label htmlFor="is_academic" className="text-gray-700 text-xl pl-3">IS ACADEMIC</label>
//             </div>
//             <label htmlFor="dept_id" className="block">Department:</label>
//             <select
//               id="dept_id"
//               name="dept_id"
//               value={formData.dept_id}
...
//               {getData && getData.map((department) => (
